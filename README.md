...
This repository features a robust, enterprise-grade data pipeline designed to automate the ingestion, processing, and orchestration of high-volume real-estate data. By leveraging a Medallion Architecture, the pipeline transforms raw data from Idealista and Barcelona Open Data into actionable insights for predictive analytics and machine learning models.
